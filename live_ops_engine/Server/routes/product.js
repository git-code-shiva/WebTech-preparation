...
//TESTING ROUTE
router.get("/shiva/signup", (req, res) => {
    res.send("signup Route working!!")
})


//NEW USER
router.post("/api/shiva/signup",
...
router.put("/api/shiva/user/:emailId",
    async (req, res) => {
...
router.get("/api/shiva/userlist", async (req, res) => {
    try {
...
//FIND ALL REGISTER USER
router.delete("/api/shiva/delete/:id", async (req, res) => {
    try {
